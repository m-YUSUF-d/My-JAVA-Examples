...
public class StopWatch {
	public static void main(String[] args) {
		...
		for (int i = 0; i < sayilar.length; i++)
			sayilar[i] = r.nextInt();
		// for döngüsü ile bu dizinin her bir elemanına rastgele tamsayı değerleri
		// atanır.

		StopWatch_Class sw = new StopWatch_Class();
		// Bir StopWatch nesnesi oluşturulur ve start() metodu çağrılarak zamanlama
		// başlatılır.
		...
		System.out.println("100.000 sayiyi siralamak " + sw.getElapsedTime() + " milisaniye sürdü");
